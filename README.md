...
Client: Zensar/ Compass digital

Must have at least 2- 3 years Lead experience
Focus on candidates with strong hands-on React + TypeScript (recent experience).
Must have explicit Redux Saga experience (watcher/worker, async flows) — avoid profiles with only Redux Toolkit/Context.
Look for Next.js production experience (SSR, SSG, routing) — not just exposure.
Prioritize candidates with Lead/Architect-level ownership (decision making, design discussions, mentoring).
Avoid profiles heavily dependent on UI libraries (MUI, Chakra, etc.) — need custom component development experience.
Target candidates with enterprise-scale applications and strong state management architecture experience.
Job Description:
